import 'package:binbox/ForgotPasswordPage.dart';
import 'package:binbox/RegisterPage.dart';
import 'package:binbox/done.dart';
...
Future<void> main() async {
  ...
  await Firebase.initializeApp(
    options: const FirebaseOptions(
      ...
      messagingSenderId: "XXXXX", // Your messagingSenderId
      projectId: "XXXXX", // Your projectId
    ),
  );
  runApp(const MyApp());
}
